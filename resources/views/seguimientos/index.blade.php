...
@section('title', 'Gestión de Pacientes y Seguimientos')
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body border-bottom">
                    <form action="{{ route('seguimientos.buscar') }}" method="POST" class="row g-3">
                        @csrf
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('seguimientos.index') }}" class="btn btn-secondary w-100">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                @forelse($pacientes as $paciente)
                                    @php
                                        $totalSeguimientos = $paciente->seguimientos_count;
                                        $seguimientosActivos = $paciente->seguimientos->where('estado', 'activo')->count();
                                    @endphp
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <div class="h6 mb-1">{{ $totalSeguimientos }}</div>
                                                <small class="text-muted">
                                                    <span class="badge bg-success">{{ $seguimientosActivos }} activos</span>
                                                </small>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('seguimientos.show', $paciente) }}" 
                                                   ...
                                                   title="Ver detalles y seguimientos">
                                                ...
                                                <a href="{{ route('seguimientos.edit', $paciente) }}" 
