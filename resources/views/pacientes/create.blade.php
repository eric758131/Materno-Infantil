        ...
        <div class="col-md-10">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('pacientes.store') }}" method="POST" id="pacienteForm" class="needs-validation" novalidate>
                        @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="tutor_apellido_paterno" id="tutor_apellido_paterno" 
                                           ...
                                           value="{{ old('tutor_apellido_paterno') }}"
                                           pattern="^[a-zA-Z\sáéíóúÁÉÍÓÚñÑ]+$"
                                           required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="tutor_apellido_materno" id="tutor_apellido_materno" 
                                           ...
                                           value="{{ old('tutor_apellido_materno') }}"
                                           pattern="^[a-zA-Z\sáéíóúÁÉÍÓÚñÑ]+$"
                                           required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="tutor_parentesco" id="tutor_parentesco" 
                                        ...
                                        <option value="abuelo" {{ old('tutor_parentesco') == 'abuelo' ? 'selected' : '' }}>Abuelo</option>
                                        <option value="abuela" {{ old('tutor_parentesco') == 'abuela' ? 'selected' : '' }}>Abuela</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="tutor_direccion" id="tutor_direccion" 
                                              ...
                                              rows="2"
                                              required>{{ old('tutor_direccion') }}</textarea>
